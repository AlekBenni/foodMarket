...
function Icecream (){
    ...
    let icecreamCount = useSelector((state:AppStateType) => state.blockIcecream)

    let resultIcecreamCount = icecreamCount.map(item => {
        return (
    ...
    return (
        ...
        <div className="alert alert-info" role="alert">
            <h5>Все товары категории мороженое:</h5>
        </div>
